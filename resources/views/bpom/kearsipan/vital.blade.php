...
<form action="" class="px-4">
    <div class="form-group">
        ...
        <input class="form-control" type="text" name="jenis_arsip">
        <small class="form-text text-muted">Jenis Arsip Vital Tercipta</small>
    </div>
    <div class="form-group">
        <label for="unit_pengolah">Unit Pengolah</label>
        <input type="text" class="form-control" name="unit_pengolah" value="Substansi Infokom" readonly>
    </div>
    <div class="form-group">
        <label for="kurun_waktu">Kurun Waktu</label>
        <input type="text" class="form-control" name="kurun_waktu" >
    ...
    <div class="form-group">
        ...
        <input type="text" name="jumlah_berkas" class="form-control">
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="" id="metode_perlind">
            <option value="">Duplikasi</option>
        </select>
    </div>
    <div class="form-group">
        <label for="lokasi">Lokasi Simpan</label>
        <input class="form-control" name="lokasi" type="text" value="Lemari khusus arsip vital" readonly>
